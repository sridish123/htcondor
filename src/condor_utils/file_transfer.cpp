...
void
FileTransfer::setV2InputFiles() {
	setV2FilesFromAttribute( ATTR_V2FT_INPUT_LIST );
}

void
FileTransfer::setV2CheckpointFiles() {
	setV2FilesFromAttribute( ATTR_V2FT_CHECKPOINT_LIST );
}

void
FileTransfer::setV2OutputFiles() {
	setV2FilesFromAttribute( ATTR_V2FT_OUTPUT_LIST );
}

void
FileTransfer::setV2FilesFromAttribute( const char * attr ) {
	std::string buffer;
